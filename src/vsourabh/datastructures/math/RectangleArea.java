 ...
 * left corner and top right corner as shown
 * in the figure.
 * 
 * Assume that the total area is never beyond
...
public class RectangleArea {
	...
	/**
	 * LeetCode:
	 * Instead of checking whether the rectangles overlap,
	 * I max right with left (and top with bottom). 
	 */
	...
	public int computeAreaPerCondition(int A, int B, int C, int D, int E, int F, int G, int H) {
		int area1 = (D - B)*(C - A);
		int area2 = (H - F)*(G - E);
		int area3 = 0;
	...
	public static void main(String[] args) {
		...
		int result = obj.computeArea(-2, -2, 2, 2, -2, -2, 2, 2);
		System.out.println("The Rectangle Area is " + result);
	
		result = obj.computeAreaPerCondition(-2, -2, 2, 2, -2, -2, 2, 2);
		System.out.println("The Rectangle Area is " + result);
	}
