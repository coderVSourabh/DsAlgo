 ...
 * polygon (Simple polygon definition). 
...
public class ConvexPolygon {
    ...
    public List<Integer> addPoint(int a, int b) {
	...
	public static void main(String[] args) {
		...
		points.add(poly.addPoint(0, 0));
		points.add(poly.addPoint(0, 1));
		points.add(poly.addPoint(1, 1));
		points.add(poly.addPoint(1, 0));
		boolean result = poly.isConvex(points);
		System.out.println("The polygon is Convex " + result);
		
		points = new ArrayList<>();
		points.add(poly.addPoint(0, 0));
		points.add(poly.addPoint(0, 10));
		points.add(poly.addPoint(10, 10));
		points.add(poly.addPoint(10, 0));
		points.add(poly.addPoint(5, 5));
		result = poly.isConvex(points);
		System.out.println("The polygon is Convex " + result);
