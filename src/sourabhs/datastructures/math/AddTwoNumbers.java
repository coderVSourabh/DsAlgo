...
public class AddTwoNumbers {
	...
	private SingleNode<Integer> reverseList(SingleNode<Integer> l) {
		SingleNode<Integer> res = null;
		while(l != null) {
			SingleNode<Integer> tmp = l.getNextNode();
			l.setNextNode(res);
			res = l;
			l = tmp;
		}
	...
	public static void main(String[] args) {
		...
		SingleNode<Integer> result = obj.reverseList(obj.addTwoNumbers(l1, l2));
		while(result != null) {
