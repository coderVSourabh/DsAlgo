 ...
 * original digits. That means invalid inputs such as "abc" or "zerone" are not permitted.
 * 
 ...
 * Output: "45"
 */
public class DigitFromAlphabets {
	...
	public static void main(String[] args) {
		DigitFromAlphabets obj = new DigitFromAlphabets();
		String alpha = obj.originalDigits("otnwoe");
		System.out.println("The digits are " + alpha);
